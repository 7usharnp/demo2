...
public class CompanyPage {
	...
	private By responsibleBussiness = By.xpath("(//a[contains(text(),'Responsible Business')])[2]");
	private By ceosDesk = By.xpath("//a[contains(text(),'CEO’s Desk')]");
	private By corporateGovernance = By.xpath("(//a[contains(text(),'Corporate Governance')])[2]");
